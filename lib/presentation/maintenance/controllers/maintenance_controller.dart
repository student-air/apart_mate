...
class MaintenanceController extends GetxController {
  ...
  /// Green card when THIS month is paid in maintenancePayments
  ...
  Future<void> _loadTenant(String userId) async {
    ...
    // Only create pending if NO doc for this month (paid or pending)
  ...
  Future<void> _loadOwner(String userId) async {
    ...
    for (final p in focusList) {
      ...
      final tenantUserId = linked.isNotEmpty ? linked.first.id : '';
