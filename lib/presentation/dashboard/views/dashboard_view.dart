...
//     final photoPath = controller.photoPath;
...
//         width: 1.5,
//       ),
//       image: controller.photoPath != null
//           ? DecorationImage(
//               image: FileImage(File(controller.photoPath!)),
//               fit: BoxFit.cover,
//             )
//           : null,
//     ),
//     alignment: Alignment.center,
//     child: controller.photoPath == null
//         ? Text(
//             controller.userName.isNotEmpty
//                 ? controller.userName[0].toUpperCase()
//                 : '?',
...
void _showComingSoon(String feature) {
  AppSnackbar.info(feature, 'Coming soon');
}
