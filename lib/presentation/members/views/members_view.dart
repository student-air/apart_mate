            ...
            child: Obx(() {
              ...
              return ListView.separated(
                ...
                itemBuilder: (_, i) {
                  ...
                  return _TenantCard(
                    tenant: t,
                    onCall: () => controller.callTenant(t),
                    onCopyCode: () => controller.copyCode(t.inviteCode),
                    onMarkPaid: () => controller.markMaintenancePaid(t),
                    onDelete: () => controller.deleteTenant(t),
                  );
                },
              );
            }),
...
class _TenantCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final t = tenant;
    final isActive = t.status.toLowerCase() == 'joined';
    final paid = t.maintenancePaid;
